...
| NEXT-03 / M3 | Capture/provenance + exact duplicate hints | Job input/storage/analyzer | M3.1 delivers raw-before-analysis, explicit metadata/legacy health and advisory hash/URL hints; M3.2 delivers candidate-reviewed links with retained source records. |
